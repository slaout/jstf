...
public class JstfMojo extends AbstractMojo {
	...
	/**
	 * Code generated by the framework will use \@Override annotations on interface methods.
	 * This annotation can not be used on interfaces in Java 5. This usage starts with Java 6.
	 * If you compile your project for Java 5, put this option to true (default is false) in order to generate Java 5 compilable code.
	 */
	@Parameter(defaultValue = "false", required = false)
	private boolean java5Compatible;

	// OPTION NOT IN TranslationGeneratorOptions
	// Only in the Maven plugin:

	/**
	 * The Maven plugin will add the generated-sources folder to the project's compilation path.
	 * If the current Maven project is only generating sources, enable this option (default is false).
	 * For instance if sources are generated into an external project, and then can not be compiled inside the current project.
	 */
	@Parameter(defaultValue = "false", required = false)
	...
	public void execute() throws MojoFailureException
	{
		...
		options.java5Compatible = java5Compatible;
		...
		if (!skipGeneratedSourcesCompilation) {
